...
if not exist "safe-proactive\snapshots" mkdir safe-proactive\snapshots
...
echo.
echo   python scripts\speace-cortex-evolver.py --once
echo   python scripts\speace_status_monitor.py --once
echo.
echo   AHK: doppio click su scripts\ahk\speace-launcher.ahk
echo  ====================================================
echo.
pause
